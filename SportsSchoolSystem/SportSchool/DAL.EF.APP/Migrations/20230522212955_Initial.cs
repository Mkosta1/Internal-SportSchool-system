        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    SportsSchoolId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MonthlySubscription", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MonthlySubscription_SportsSchool_SportsSchoolId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Training_SportsSchool_SportsSchoolId",
                        column: x => x.SportsSchoolId,
                        principalTable: "SportsSchool",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlySubscriptionId = table.Column<Guid>(type: "uuid", nullable: true),
                    SportsSchoolId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_MonthlySubscription_MonthlySubscriptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAtCompetition", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserAtCompetition_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserAtCompetition_Competition_CompetitionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Since = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_MonthlySubscriptionId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonthlySubscription_SportsSchoolId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Training_SportsSchoolId",
                table: "Training",
                column: "SportsSchoolId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAtCompetition_AppUserId",
                table: "UserAtCompetition",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAtCompetition_CompetitionId",
                table: "UserAtCompetition",
